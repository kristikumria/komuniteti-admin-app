...
import { AdministratorStackParamList, BusinessManagerStackParamList, Report } from '../../../navigation/types';
...
// Add support for tablet layout
interface MaintenanceListProps extends Props {
...
export const MaintenanceList: React.FC<MaintenanceListProps> = ({ navigation, customSelectHandler, selectedMaintenanceId }) => {
