...
import { Text, useTheme, ActivityIndicator, Card, Button, Divider, FAB, Badge as PaperBadge, Searchbar, RadioButton, Avatar, Subheading } from 'react-native-paper';
import { 
  UserRound, 
  Building, 
  Mail, 
...
export const ResidentDetails: React.FC<ResidentDetailsProps> = ({ residentId: propResidentId, hideHeader = false }) => {
  ...
  // Add proper null checks for resident
  ...
  // Add proper null checks for other sections
  const renderBuildingInfo = () => {
    if (!resident) return null;
    
    return (
      <View>
        <Subheading style={styles.sectionTitle}>Building Information</Subheading>
        <ListItem
          leftIcon={<Building size={24} color={theme.colors.primary} />}
          title="Building and Unit"
          description={`${resident.building}, Unit ${resident.unit}`}
        />
        
        <ListItem
          leftIcon={<Home size={24} color={theme.colors.primary} />}
          title="Status"
          description={resident.status === 'owner' ? 'Owner' : 'Tenant'}
        />
        
        <ListItem
          leftIcon={<Calendar size={24} color={theme.colors.primary} />}
          title="Move-in Date"
          description={new Date(resident.moveInDate).toLocaleDateString()}
        />
        
        <ListItem
          leftIcon={<Users size={24} color={theme.colors.primary} />}
          title="Family Members"
          description={resident.familyMembers ? resident.familyMembers.toString() : '0'}
        />
      </View>
    );
  };
            ...
            {residentProperty ? (
              <View>
                <View style={styles.propertyRow}>
                  ...
                  <View>
                    ...
                    <Text variant="bodyMedium" style={styles.propertyDetails}>
                      {residentProperty.bedrooms} bed • {residentProperty.bathrooms} bath
                    </Text>
                  </View>
                </View>
                ...
                <View style={styles.propertyRow}>
                  ...
                  <Text variant="bodyMedium">
                    Floor {residentProperty.floor} • {residentProperty.size} m²
                  </Text>
                </View>
                ...
                <View style={styles.propertyRow}>
                  ...
                  <Text variant="bodyMedium">
                    Monthly Rent: ${residentProperty.rent}
                  </Text>
                </View>
                  ...
                  <View style={styles.propertyItemDetails}>
                    ...
                    <View style={styles.propertyItemInfo}>
                      ...
                      <Text variant="bodySmall">
                        {item.bedrooms} bed • ${item.rent}/mo
                      </Text>
                    </View>
                  </View>
